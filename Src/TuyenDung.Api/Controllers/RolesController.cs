...
namespace TuyenDung.Api.Controllers
{
    public class RolesController : BaseController
    {
        ...
        [HttpPost]
        public async Task<IActionResult> PostRole(RoleModel request)
        {
        ...
        public async Task<IActionResult> GetRoles()
        {
            ...
            var rolevms = await roles.Select(r => new RoleModel()
            {
                Id = r.Id,
                Name = r.Name
            }).ToListAsync();
        ...
        public async Task<IActionResult> GetRolesPaging(string filter, int pageIndex, int pageSize)
        {
            ...
            var pagination = new Pagination<RoleModel>
            {
                Items = items,
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutRole(string id, [FromBody] RoleModel roleVm)
        {
            if (id != roleVm.Id)
