...
namespace TuyenDung.Common.XBaseModel
{
    ...
    public class PagedList<T> : List<T>, IPagedList<T>
    {
        ...
        {
            if (pageSize > PagedListHelper.MaxPageSize)
                throw new XBaseException($"{nameof(pageSize)} must be less than or equal to {nameof(PagedListHelper.MaxPageSize)} (${PagedListHelper.MaxPageSize})");
